      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="mt-6 flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-meumini-orange transition-colors">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <a href="#" className="text-meumini-light-gray hover:text-meumini-orange transition-colors">Como Funciona</a>
              </li>
              <li>
                <a href="#" className="text-meumini-light-gray hover:text-meumini-orange transition-colors">Galeria</a>
              </li>
              <li>
                <a href="#" className="text-meumini-light-gray hover:text-meumini-orange transition-colors">Perguntas Frequentes</a>
              </li>
              <li>
                <a href="#" className="text-meumini-light-gray hover:text-meumini-orange transition-colors">Blog</a>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-8 border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between">
          <p className="text-meumini-light-gray text-sm">
            &copy; {new Date().getFullYear()} MeuMini. Todos os direitos reservados.
          </p>
